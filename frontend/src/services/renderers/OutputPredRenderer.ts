...
export class OutputPredRenderer extends BaseQuestionRenderer {
    ...
    mount(): void {
        const code = el(
            "pre",
            {
                class: "mono text-sm bg-surface-alt border border-border rounded-lg p-4 overflow-auto",
            },
        ...
        options.forEach((opt, i) => {
            ...
            btn.append(
                el("span", { class: "font-mono font-semibold mr-2" }, [
            ...
            btn.addEventListener("click", () => {
                ...
                wrap.querySelectorAll("button").forEach((b) =>
                    b.classList.remove("border-primary", "bg-surface-alt"),
                );
