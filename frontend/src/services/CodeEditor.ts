 ...
 */
export async function createCodeEditor(host: HTMLElement, opts: CodeEditorOptions): Promise<CodeEditorHandle> {
  try {
    ...
    ta.className = "mono w-full p-3 rounded-lg border border-border bg-surface text-sm resize-y";
